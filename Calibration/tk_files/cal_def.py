...
def transfer_point_inverse(pt, pose):
    ...
    t['orient'].inverse()
    r_pt = pt.get_rotated(t['orient'])
    return r_pt.sub_vector3(pose['position'])
...
def draw_dots(dimen, pts, ax, c):
    if (dimen == 3):
        ...
        if (c == 'green'):
            ...
            ax.scatter(x, y, z, marker='o', s=20, color=c, alpha=0.5)
        ax.quiver(x, y, z, u, v, w, length=0.03, linewidths=0.2, color='red', normalize=True)
...
DISABLE = 0
# offset value
offset = {'position': vector3(0.05, 0.05, 0.05), 'orient': get_quat_from_euler('xyz', [3, 6, 10])}
# 추가 된 카메라 정보
camera_array = []
# 카메라 별 변환된 좌표 array
trans_leds_array = []
...
camera_section_2 = DISABLE
camera_section_3 = DISABLE
...
if camera_section_1 == ENABLE:  
    camera_array.append({'idx': 0, 'position': vector3(0, 0, 0.5), 'orient': get_quat_from_euler('xyz', [0, -90, 0])})
    camera_array.append({'idx': 1, 'position': vector3(0, 0, 0.5), 'orient': get_quat_from_euler('xyz', [0, 90, 0])})
    camera_array.append({'idx': 2, 'position': vector3(0, 0, 0.5), 'orient': get_quat_from_euler('xyz', [90, 0, 0])})
    camera_array.append({'idx': 3, 'position': vector3(0, 0, 0.5), 'orient': get_quat_from_euler('xyz', [-90, 0, 0])})
    if camera_half_section == ENABLE:
        camera_array.append({'idx': 4, 'position': vector3(0, 0, 0.5), 'orient': get_quat_from_euler('xyz', [45, 90, 0])})
        camera_array.append({'idx': 5, 'position': vector3(0, 0, 0.5), 'orient': get_quat_from_euler('xyz', [-45, 90, 0])})
        camera_array.append({'idx': 6, 'position': vector3(0, 0, 0.5), 'orient': get_quat_from_euler('xyz', [45, -90, 0])})
        camera_array.append({'idx': 7, 'position': vector3(0, 0, 0.5), 'orient': get_quat_from_euler('xyz', [-45, -90, 0])})

# section 2
if camera_section_2 == ENABLE:
    camera_array.append({'idx': 8, 'position': vector3(0, 0, 0.5), 'orient': get_quat_from_euler('xyz', [0, -135, 0])})
    camera_array.append({'idx': 9, 'position': vector3(0, 0, 0.5), 'orient': get_quat_from_euler('xyz', [0, 135, 0])})
    camera_array.append({'idx': 10, 'position': vector3(0, 0, 0.5), 'orient': get_quat_from_euler('xyz', [135, 0, 0])})
    camera_array.append({'idx': 11, 'position': vector3(0, 0, 0.5), 'orient': get_quat_from_euler('xyz', [-135, 0, 0])})
    if camera_half_section == ENABLE: 
        camera_array.append({'idx': 12, 'position': vector3(0, 0, 0.5), 'orient': get_quat_from_euler('xyz', [45, 135, 0])})
        camera_array.append({'idx': 13, 'position': vector3(0, 0, 0.5), 'orient': get_quat_from_euler('xyz', [-45, 135, 0])})
        camera_array.append({'idx': 14, 'position': vector3(0, 0, 0.5), 'orient': get_quat_from_euler('xyz', [45, -135, 0])})
        camera_array.append({'idx': 15, 'position': vector3(0, 0, 0.5), 'orient': get_quat_from_euler('xyz', [-45, -135, 0])})

# section 3
if camera_section_3 == ENABLE:
    camera_array.append({'idx': 16, 'position': vector3(0, 0, 0.5), 'orient': get_quat_from_euler('xyz', [0, -45, 0])})
    camera_array.append({'idx': 17, 'position': vector3(0, 0, 0.5), 'orient': get_quat_from_euler('xyz', [0, 45, 0])})
    camera_array.append({'idx': 18, 'position': vector3(0, 0, 0.5), 'orient': get_quat_from_euler('xyz', [45, 0, 0])})
    camera_array.append({'idx': 19, 'position': vector3(0, 0, 0.5), 'orient': get_quat_from_euler('xyz', [-45, 0, 0])})
    if camera_half_section == ENABLE: 
        camera_array.append({'idx': 20, 'position': vector3(0, 0, 0.5), 'orient': get_quat_from_euler('xyz', [45, 45, 0])})
        camera_array.append({'idx': 21, 'position': vector3(0, 0, 0.5), 'orient': get_quat_from_euler('xyz', [-45, 45, 0])})
        camera_array.append({'idx': 22, 'position': vector3(0, 0, 0.5), 'orient': get_quat_from_euler('xyz', [45, -45, 0])})
        camera_array.append({'idx': 23, 'position': vector3(0, 0, 0.5), 'orient': get_quat_from_euler('xyz', [-45, -45, 0])})
