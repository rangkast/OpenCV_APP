...
Java_project_test_fastcv_1app_FastCVSample_cleanup
(
   JNIEnv * env, 
   jobject obj
)
...
extern "C" JNIEXPORT void
   JNICALL Java_project_test_fastcv_1app_FastCVSample_update
(
   JNIEnv*     env, 
   jobject     obj, 
   jbyteArray  img, 
...
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
extern "C" JNIEXPORT void JNICALL Java_project_test_fastcv_1app_FastCVSample_init
(
   JNIEnv* env, 
   jobject obj
)
...
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
extern "C" JNIEXPORT int JNICALL Java_project_test_fastcv_1app_FastCVSample_getNumCorners
(
   JNIEnv*  env, 
   jobject  obj
)
...
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
extern "C" JNIEXPORT jfloat JNICALL Java_project_test_fastcv_1app_FastCVSample_getCameraFPS
(
   JNIEnv*  env, 
   jobject  obj
)
...
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
extern "C" JNIEXPORT void JNICALL Java_project_test_fastcv_1app_FastCVSample_cameraFrameTick
(
   JNIEnv*  env, 
   jobject  obj
)
...
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
extern "C" JNIEXPORT void JNICALL Java_project_test_fastcv_1app_FastCVSample_setScaling
(
   JNIEnv*  env, 
   jobject  obj,
   int scaleFactor
...
//------------------------------------------------------------------------------
extern "C" JNIEXPORT void JNICALL
Java_project_test_fastcv_1app_FastCVSample_setFastCornerThreshold
(
   JNIEnv*  env, 
   jobject  obj,
   int threshold
...
//------------------------------------------------------------------------------
extern "C" JNIEXPORT void JNICALL
Java_project_test_fastcv_1app_FastCVSample_setViewFinderEnable
(
   JNIEnv*  env, 
   jobject  obj,
...
//------------------------------------------------------------------------------
extern "C" JNIEXPORT void
   JNICALL Java_project_test_fastcv_1app_FastCVSample_setOverlayPixelsEnable
(
   JNIEnv*  env, 
   jobject  obj,
...
//------------------------------------------------------------------------------
extern "C" JNIEXPORT void
   JNICALL Java_project_test_fastcv_1app_FastCVSample_setGaussianEnable
(
   JNIEnv*  env, 
   jobject  obj,
...
Java_project_test_fastcv_1app_FastCVSample_getFastCVProcessTime
(
   JNIEnv*  env, 
   jobject  obj
)
