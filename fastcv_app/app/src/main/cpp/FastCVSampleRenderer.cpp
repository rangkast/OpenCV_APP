...
Java_project_test_fastcv_1app_FastCVSampleRenderer_cleanup
(
   JNIEnv * env, 
   jobject obj
)
...
//------------------------------------------------------------------------------
extern "C" JNIEXPORT void JNICALL
Java_project_test_fastcv_1app_FastCVSampleRenderer_surfaceChanged
(
...
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
extern "C" JNIEXPORT void JNICALL Java_project_test_fastcv_1app_FastCVSampleRenderer_render
(
   JNIEnv * env, 
   jobject obj, 
   jbyteArray img, 
...
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
extern "C" JNIEXPORT jfloat JNICALL Java_project_test_fastcv_1app_FastCVSampleRenderer_getGPUFPS
(
   JNIEnv*  env, 
   jobject  obj
)
