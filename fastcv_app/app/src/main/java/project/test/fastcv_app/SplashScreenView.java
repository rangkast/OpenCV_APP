...
import project.test.fastcv_app.R;
import project.test.fastcv_app.SplashScreen;
 ...
 * 
 *  */
public class SplashScreenView extends androidx.appcompat.widget.AppCompatImageView {
