...
if __name__ == "__main__":
    ...
    for i in range(len(results[0])):
        ...
        ax.scatter(results[1][i][0], results[1][i][1], color='black', marker='o', s=1)
    ...
    # Test
    result_data = rw_json_data(READ, '../blender_3d/image_output/blender_test_image.json', None)
    ax.scatter([coord[0] for coord in result_data['CAMERA_0']['OpenCV']],
               [coord[1] for coord in result_data['CAMERA_0']['OpenCV']], color='blue', marker='o', s=1)
    ax.scatter([coord[0] + CAP_PROP_FRAME_WIDTH for coord in result_data['CAMERA_1']['OpenCV']],
               [coord[1] for coord in result_data['CAMERA_1']['OpenCV']], color='blue', marker='o', s=1)

    ax.scatter([coord[0] for coord in result_data['CAMERA_0']['Obj_Util']],
               [coord[1] for coord in result_data['CAMERA_0']['Obj_Util']], color='red', marker='o', s=1)
    ax.scatter([coord[0] + CAP_PROP_FRAME_WIDTH for coord in result_data['CAMERA_1']['Obj_Util']],
               [coord[1] for coord in result_data['CAMERA_1']['Obj_Util']], color='red', marker='o', s=1)

    # ax.scatter([coord[0] for coord in result_data['CAMERA_0']['Project']],
    #            [coord[1] for coord in result_data['CAMERA_0']['Project']], color='green', marker='o', s=1)
    # ax.scatter([coord[0] + CAP_PROP_FRAME_WIDTH for coord in result_data['CAMERA_1']['Project']],
    #            [coord[1] for coord in result_data['CAMERA_1']['Project']], color='green', marker='o', s=1)
